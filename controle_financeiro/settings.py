...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-!(ha2^_s@j^kv&cw-(ouz$smclu&hy^zi4%3q0trji)fothtk@')
...
INSTALLED_APPS = [
    ...
    'financeiro',  # App principal do sistema
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='controle_financeiro'),
